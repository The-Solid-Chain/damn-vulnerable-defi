...
describe("[Challenge] The rewarder", function () {
    ...
    it("Exploit", async function () {
        ...
        const TheRewarderAbuserFactory = await ethers.getContractFactory("TheRewarderAbuser", attacker);
        this.rewardAbuser = await TheRewarderAbuserFactory.deploy();

        await this.rewardAbuser.attack(
