...
describe("[Challenge] Free Rider", function () {
    ...
    it("Exploit", async function () {
        ...
        const FreeRiderAbuserFactory = await ethers.getContractFactory("FreeRiderAbuser", attacker);
        const FreeRiderAbuser = await FreeRiderAbuserFactory.deploy(this.weth.address);

        const abuserFunding = ethers.utils.parseEther("0.4");

        await FreeRiderAbuser.attack(
